...
<p><code>[file_manager_advanced login="yes" roles="author,editor,administrator" path="wp-content" hide="plugins" operations="upload,download" block_users="1,5" view="grid" theme="light" lang ="en"]</code></p>
<h3>Parameters: </h3>
